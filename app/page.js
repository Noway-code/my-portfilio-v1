				...
				<section className={'min-h-screen'}>
					...
					<div className={'flex flex-col md:flex-row items-center'}>
						...
						<div className={'relative mx-auto rounded-full w-80 h-80 mt-10 overflow-hidden md:h-96 md:w-96 group'}>
							<div
								className={'w-full h-full absolute bg-blue-900 opacity-50 transition-opacity group-hover:opacity-0 z-10'}
					...
					<div className={'text-5xl flex flex-col items-start py-3 text-gray-500'}>
						<AiFillYoutube />
						<AiFillLinkedin />
						<AiFillTwitterCircle />
					</div>
