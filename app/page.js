		...
		<div className={'mx-auto h-full w-full min-h-screen'}>
			...
			<main className={'px-10 md:px-40 lg:px-40'}>
				<section className={'min-h-screen flex flex-col items-center justify-center'}>
					...
					<div className={'max-w-5xl w-full p-6 md:p-8 bg-blue-400 shadow-md rounded-2xl flex items-center bg-gradient-to-bl from-cyan-600 to-purple-500'}>
						<div className={'w-1/2 pr-6 '}>
							...
							<ul className={'text-lg py-2 text-gray-200 '}>
				...
				<section style={{backgroundColor: '#37456b'}} className={"px-4 py-8 rounded-lg "}>
